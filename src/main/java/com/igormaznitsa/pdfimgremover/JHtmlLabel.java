/*
 * Copyright (C) 2018-2022 Igor Maznitsa
 *
...
public class JHtmlLabel extends JLabel {
    ...
    /**
     * Internal auxiliary class to keep cached parameters of found link
     * elements.
     */
    ...
    public void setText(final String text) {
        super.setText(text.toLowerCase(Locale.ENGLISH).trim().startsWith("<html>")
                ? //NOI18N
